...
import {
  ...
  SheetContent,
  SheetTrigger,
} from "@/app/presentation/components/ui/sheet";
import {
  NavigationMenu,
  NavigationMenuLink,
  NavigationMenuItem,
...
import {
  ...
  SelectTrigger,
  SelectValue,
} from "@/app/presentation/components/ui/select";
    ...
    >
      <div className="container mx-auto px-4">
        <div className="flex items-center justify-center h-16 lg:h-20 relative">
          <Link
            href="/"
            className="absolute left-4 flex items-center space-x-2 group"
          >
          ...
          <div className="absolute right-4 flex items-center space-x-2">
            ...
            >
              <SelectTrigger className="w-[140px]">
                ...
                <SelectValue>
                  {intl.formatMessage({
                    id: languages.find((lang) => lang.code === locale)?.name,
                  })}
                </SelectValue>
              </SelectTrigger>
              <SelectContent>
                ...
                <div className="pt-4 border-t">
                  ...
                  >
                    <SelectTrigger className="w-full">
                      ...
                      <SelectValue>
                        {intl.formatMessage({
                          id: languages.find((lang) => lang.code === locale)
                            ?.name,
                        })}
                      </SelectValue>
                    </SelectTrigger>
