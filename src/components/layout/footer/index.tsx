...
export default function Footer() {
  ...
  const footerSections = [
    ...
    },
    {
      ...
      links: [
        { name: intl.formatMessage({ id: "footer.features" }), href: "/#features" },
        { name: intl.formatMessage({ id: "footer.pricing" }), href: "/pricing" },
    ...
    },
    {
      ...
      links: [
        { name: intl.formatMessage({ id: "footer.documentation" }), href: "/docs" },
        { name: intl.formatMessage({ id: "footer.guides" }), href: "/guides" },
        { name: intl.formatMessage({ id: "footer.support" }), href: "/support" },
    ...
    },
    {
      ...
      links: [
        ...
        { name: intl.formatMessage({ id: "footer.license" }), href: "/license" },
      ],
    },
  ]

  const socialLinks = [
    { icon: <Facebook className="h-5 w-5" />, href: "https://facebook.com/arm-saas-az" },
    { icon: <Twitter className="h-5 w-5" />, href: "https://twitter.com/arm_saas_az" },
    { icon: <Instagram className="h-5 w-5" />, href: "https://instagram.com/arm.saas.az" },
    { icon: <Linkedin className="h-5 w-5" />, href: "https://linkedin.com/company/arm-saas-az" },
    { icon: <Github className="h-5 w-5" />, href: "https://github.com/arm-saas-az" },
  ]
    ...
    <footer className="bg-slate-900 text-white">
      ...
      <div className="container mx-auto px-4 py-16">
        <div className="grid lg:grid-cols-5 gap-8">
          ...
          {/* Company Links */}
          <div>
            <h3 className="text-lg font-semibold mb-6">{intl.formatMessage({ id: "footer.company" })}</h3>
          ...
          {/* Product Links */}
          <div>
            <h3 className="text-lg font-semibold mb-6">{intl.formatMessage({ id: "footer.product" })}</h3>
            <ul className="space-y-3">
          ...
          {/* Support Links */}
          <div>
            <h3 className="text-lg font-semibold mb-6">{intl.formatMessage({ id: "footer.resources" })}</h3>
            <ul className="space-y-3">
        ...
        <div className="container mx-auto px-4 py-8">
          <div className="flex flex-col lg:flex-row items-center justify-between space-y-4 lg:space-y-0">
            ...
            <div className="flex items-center space-x-4">
              <span className="text-slate-400 text-sm">{intl.formatMessage({ id: "footer.socials" })}:</span>
